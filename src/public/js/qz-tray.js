                ...
                findConnection: function(config, resolve, reject) {
                    ...
                    if (!config.port.secure.length) {
                        if (!config.port.insecure.length) {
                            ...
                            _qz.log.warn("No secure ports specified - forcing insecure connection");
                            config.usingSecure = false;
                        }
                    } else if (!config.port.insecure.length) {
                        _qz.log.warn("No insecure ports specified - forcing secure connection");
