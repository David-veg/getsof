...
var myChart = echarts.init(document.getElementById('VentasFormasPago'));
    ...
    series : [
        {
            ...
            center: ['50%', '60%'],
            data:[
                {value:335, name:'EFECTIVO'},
                {value:310, name:'CRÉDITO'},
                {value:234, name:'CHEQUE'},
                {value:135, name:'DEP/TRANS'},
                {value:300, name:'TARJETA CRÉDITO'}
            ],
            itemStyle: {
                emphasis: {
                    shadowBlur: 10,
